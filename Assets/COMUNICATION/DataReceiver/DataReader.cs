...
public class DataReader : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string filePath;
        if (isVlc) { filePath = Path.Combine(Application.dataPath, "Logics/vlcData.json"); }
        else { filePath = Path.Combine(Application.dataPath, "Logics/data.json"); }
        ...
        if (File.Exists(filePath))
        {
            ...
            boundX = data.nodos.First().Value.x;
            boundY = data.nodos.First().Value.y;
        ...
        manager.eliminateNodesWithNoConections();
    }
}
[System.Serializable]
public class Data
